...
//		String filetype = "pdf";
		...
		prefs.put("download.default_directory","C:\\Users\\Admin\\Desktop\\TATA CVBU & PCBU OUTPUT DATA\\MisSpares");
		...
		FileInputStream file = new FileInputStream("C:\\Users\\Admin\\Desktop\\TATA CVBU &  PCBU INPUT DATA\\MisSpares.xlsx");
		...
		for (int i = 1; i <= rowcount; i++) {
			...
			String availability = celldata.getCell(2).getStringCellValue();
			...
			// click on  Mis Sparees
			
			driver.findElement(By.xpath("//span[@class=\"siebui-screen-name-1\"]//a[text()=\"MIS - Spares\"]")).click();
			
			// click on Mis Spares
			
			driver.findElement(By.xpath("//span[@class=\"siebui-screen-name-2\"]//a[text()=\"MIS - Spares\"]")).click();
			
						
			// click search button
			
			driver.findElement(By.xpath("//button[@title=\"Inventory Level:Query\"]")).click();
			
			// Availability Value
			
			WebElement st = driver.findElement(By.xpath("//td[@aria-roledescription=\"Availability\"]"));
			
			Actions act = new Actions(driver);
			act.click(st).build().perform();
			                                                 
			
			WebElement sta =  driver.findElement(By.xpath("//input[@name=\"Availability\"]"));
			sta.sendKeys(availability);
...
//
			...
			wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[text()=\"Availability\"]")));
//			
...
//			Thread.sleep(2000);
			...
			driver.findElement(By.xpath("//button[@aria-label=\"Inventory Level Menu List\"]")).click();
