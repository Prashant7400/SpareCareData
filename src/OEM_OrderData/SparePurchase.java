...
//		String filetype = "pdf";
		...
		prefs.put("download.default_directory","C:\\Users\\Admin\\Desktop\\TATA CVBU & PCBU OUTPUT DATA\\SparePurchaseOrderData");
		...
		FileInputStream file = new FileInputStream("C:\\Users\\Admin\\Desktop\\TATA CVBU &  PCBU INPUT DATA\\SparePurchaseOrderData.xlsx");
		...
		for (int i = 1; i <= rowcount; i++) {
			...
			String invoicedate = celldata.getCell(3).getStringCellValue();
	       ...
	       WebElement trdate = driver.findElement(By.xpath("//td[@aria-roledescription=\"Invoice_Date\"]"));
			
			act.click(trdate).build().perform();
			
			WebElement tradate = driver.findElement(By.xpath("//input[@name=\"TM_Invoice_Date\"]"));
			tradate.sendKeys(invoicedate);
			...
			wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[text()=\"Status\"]")));
...
//			driver.navigate().refresh();
			...
			driver.findElement(By.xpath("//button[@title=\"Recv Line Items - Purchase Menu\"]")).click();
