...
//		System.setProperty("webdriver.edge.driver", "C:\\Edge\\msedgedriver.exe");
		...
		FileInputStream file = new FileInputStream("C:\\Users\\Admin\\Desktop\\new Dealer Onboarding  Novelty2.xlsx");
...
//			String ModulesSelected = celldata.getCell(6).getStringCellValue();
			...
			// Select Dealer
			 ...
			 driver.findElement(By.xpath("//option[text()=\"AG MOTORS\"]")).click();
			Thread.sleep(2000);
//				 
...
//					Thread.sleep(5000);
			...
			// Select Location 
			if(SelectLocation.equals(SelectLocation)) {
...
//			selmodules.sendKeys(SelectModules);
			...
			// Modules selected first Disselectall
			
//			List <WebElement> mod = driver.findElements(By.xpath("//select[@id=\"ContentPlaceHolder1_lstSelectAtbute\"]//option"));
//			mod.clear();
			
		// Disselect one by one
			
//			WebElement  module = driver.findElement(By.xpath("//*[@id=\"ContentPlaceHolder1_ddldealerstaff\"]/option[4]"));
//			
...
//			}
	      ...
	      WebElement active = driver.findElement(By.xpath("//option[text()=\"Active\"]"));
			...
			// Click Add Dealer User
			
			driver.findElement(By.xpath("(//input[@name=\"btn_Submit\"])[1]")).click();
