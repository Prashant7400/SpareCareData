...
public class Script_Non_Moving_Child_Cosignee {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div/div[2]/div/div/div[4]/div/input[2]"))
				.click();

		FileInputStream file = new FileInputStream("C:\\Users\\Admin\\Desktop\\Dealer Onboarding mahanth motors (1).xlsx");
		XSSFWorkbook workbook = new XSSFWorkbook(file);
		XSSFSheet sheet = workbook.getSheet("ChildNonMov");
		...
		for (int i = 2; i <= rownum; i++) {
			...
			String MotherLocation = data.getCell(4).getStringCellValue();
			String InventorySale = data.getCell(5).getStringCellValue();
			String NonMovingSale = data.getCell(6).getStringCellValue();
			String PurchaseStockTransfer = data.getCell(7).getStringCellValue();
...
//			String Other  = data.getCell(14).getStringCellValue();
			...
			WebElement Motlocation = driver.findElement(By.id("ddlparent"));
			Motlocation.sendKeys(MotherLocation);

			// Inventory Sale

			WebElement invensale = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[5]/div/div[1]/label/label"));
			...
			WebElement invensale1 = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[5]/div/div[2]/label/label"));
			...
			WebElement invensale2 = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[5]/div/div[3]/label/label"));
			...
			WebElement nmovsale = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[6]/div/div[1]/label/label"));
			...
			WebElement nmovsale1 = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[6]/div/div[2]/label/label"));
			...
			WebElement nmovsale2 = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[6]/div/div[3]/label/label"));
			...
			WebElement stocktranfer = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[7]/div/div[1]/label/label"));
			...
			WebElement stocktranfer1 = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[7]/div/div[2]/label/label"));
			...
			WebElement stocktranfer2 = driver.findElement(
					By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div[2]/div/div/div[7]/div/div[3]/label/label"));
