...
public class Script_Workshop_Management_Gainer1 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		for (int i = 2; i <= rowcount; i++) {
			...
			String Name = celldata.getCell(11).getStringCellValue();
			String Designation = celldata.getCell(12).getStringCellValue();
			String Email = celldata.getCell(13).getStringCellValue();
			String ContactNo = celldata.getCell(14).getStringCellValue();
			String DOB = celldata.getCell(15).getStringCellValue();
			String Sequence = celldata.getCell(16).getStringCellValue();
			String ConsigneePerson = celldata.getCell(17).getStringCellValue();
			String ConsigneePersonForWarranty = celldata.getCell(18).getStringCellValue();
			String AlertLimit = celldata.getCell(19).getStringCellValue();
			String UpperLimit = celldata.getCell(20).getStringCellValue();
			String OrderBlocked = celldata.getCell(21).getStringCellValue();
			String PurDR = celldata.getCell(22).getStringCellValue();
			String SaleCR = celldata.getCell(23).getStringCellValue();
			String ClaimSetl = celldata.getCell(24).getStringCellValue();
			String MACCR = celldata.getCell(25).getStringCellValue();
			String MACDR = celldata.getCell(26).getStringCellValue();
			String WalletFB = celldata.getCell(27).getStringCellValue();
			String NotVisibleToSPM = celldata.getCell(28).getStringCellValue();
			String CompanyName = celldata.getCell(29).getStringCellValue();
			String Zone = celldata.getCell(30).getStringCellValue();
			String DefaultCompany = celldata.getCell(31).getStringCellValue();
			String NotVisibleToSPM1 = celldata.getCell(32).getStringCellValue();
			String VirtualAccountNo = celldata.getCell(33).getStringCellValue();
			String CompanyName1 = celldata.getCell(34).getStringCellValue();
			String Zone1 = celldata.getCell(35).getStringCellValue();
			String DefaultCompany1 = celldata.getCell(36).getStringCellValue();
			String ForWarranty = celldata.getCell(37).getStringCellValue();
			String ForOther = celldata.getCell(38).getStringCellValue();
			String ForDoc = celldata.getCell(39).getStringCellValue();
...
//			 WebElement ser = driver.findElement(By.xpath("//td[text()=\" TASMNA101\"]"));
//			 ser.click();
//			 Thread.sleep(3000);

			driver.findElement(By.xpath("//*[@id=\"abc_filter\"]/label/input")).sendKeys(City);
			Thread.sleep(3000);
...
//			driver.findElement(By.xpath("//option[text()=\"MAHARASHTRA\"]")).click();
//			Thread.sleep(4000);
			...
			if(SelectBrand.equals(SelectBrand)) {
				for(int j = 0; j<= 5;j++) {
			...
			driver.findElement(By.xpath("//input[@id=\"txtDesignation\"]")).sendKeys(Designation);
			Thread.sleep(1000);
