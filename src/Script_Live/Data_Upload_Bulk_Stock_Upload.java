...
//		option.addArguments("--headless");
		...
		// Print Date  into NotePadC:\Users\Admin\Desktop\jcbstk\FRONTIER COMERCIAL VEHICL.xlsx
		

		  SimpleDateFormat dateformat = new SimpleDateFormat("MM/dd/yyyy  HH:mm:ss");
			
			Date date = new Date();
			String currentdate = dateformat.format(date).trim();
			
			PrintStream ps1 = new PrintStream("C:\\Users\\Admin\\Desktop\\ConsoalResult.txt");
			
			ps1.println(currentdate);
...
//		rb43.delay(1000);
//
//		StringSelection ss43 = new StringSelection("C:\\Users\\Admin\\Desktop\\jcbstk\\SIDDHARTH AUTO ENGINEERS.xlsx");
