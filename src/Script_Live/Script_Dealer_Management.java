...
public static void main(String[]args) throws IOException, InterruptedException {
		...
		for(int i=2;i<=rowcount;i++) {
			...
			String dealername = celldata.getCell(0).getStringCellValue();
			String brand = celldata.getCell(1).getStringCellValue();
			String brandsegment = celldata.getCell(2).getStringCellValue();
			//String parentcode = celldata.getCell(3).getStringCellValue();
			String approvingstatus = celldata.getCell(4).getStringCellValue();
			String reportingstatus = celldata.getCell(5).getStringCellValue();
			String sharingstatus = celldata.getCell(6).getStringCellValue();
