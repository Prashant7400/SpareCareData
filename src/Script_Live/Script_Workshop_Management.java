...
public class Script_Workshop_Management {
...
public static void main(String[]args) throws IOException, InterruptedException {
		...
		for (int i = 2; i <= rowcount; i++) {
			...
			String OEMCode = celldata.getCell(5).getStringCellValue();
	     	String ConsignType = celldata.getCell(6).getStringCellValue();	
	     	String MotherLocation= celldata.getCell(7).getStringCellValue();
//	     	String EndDatewithSpareCare = celldata.getCell(8).getStringCellValue();
			String AuditExecutive = celldata.getCell(8).getStringCellValue();
			String OrderingConsultant = celldata.getCell(9).getStringCellValue();
			String OEMExecutive = celldata.getCell(10).getStringCellValue();
			String Status = celldata.getCell(11).getStringCellValue();
			String SharingStatus = celldata.getCell(12).getStringCellValue();
			String OrderGenerationStatus = celldata.getCell(13).getStringCellValue();
			String BDM = celldata.getCell(14).getStringCellValue();
			String AutoApproval = celldata.getCell(15).getStringCellValue();
			String DeshboardPPNI = celldata.getCell(16).getStringCellValue();
			String LowStockAlert = celldata.getCell(17).getStringCellValue();
			String LiveStocktoSale = celldata.getCell(18).getStringCellValue();
			
			
			
			Actions act = new Actions(driver);

			// Click Add Dealer Workshop
			...
			WebElement childconsign = driver.findElement(By.xpath("//*[@id=\"collapse1\"]/div/div/div[7]/div/div[2]/label/span/label"));
			if(ConsignType.equals(childconsign.getText())) {
				driver.findElement(By.xpath("//*[@id=\"collapse1\"]/div/div/div[7]/div/div[2]/label/span/label")).click();
			}
			
			
        	// Mother Location
			
			WebElement location = driver.findElement(By.id("ddlparent"));
			
			if (MotherLocation.equals(location.getText())) {
...
//			 driver.findElement(By.xpath("//*[@id=\"form1\"]/div[5]/div/div/div/div/div[2]/div/div/div[3]/div/input[2]")).click();
			 ...
			 System.out.println("SelectBrand : "+SelectBrand  +  "   SelectDealer : " +SelectDealer  + "   WorkshopLocation : " +WorkshopLocation  + "  LocationPrifix : "  +LocationPrifix  + "   StartDatewithSpare : " +StartDatewithSpare  + "  OEMCode :" +OEMCode  + "  AuditExecutive :" +AuditExecutive  + 
					 
					"  OrderingConsultant : " +OrderingConsultant  + "  OEMExecutive : " +OEMExecutive  + "  Status : " +Status  + "  SharingStatus : " +SharingStatus  + "  OrderGenerationStatus : " +OrderGenerationStatus  + "  BDM : " +BDM  + "  AutoApproval : " +AutoApproval  +  "  DeshboardPPNI : " +DeshboardPPNI  + "  LowStockAlert : " +LowStockAlert  +
					
					 
					"  LiveStocktoSale : " +LiveStocktoSale); 
