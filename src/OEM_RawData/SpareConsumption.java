...
//		String filetype = "pdf";
		...
		prefs.put("download.default_directory", "C:\\Users\\Admin\\Desktop\\TATA CVBU & PCBU OUTPUT DATA\\SpareConsumption");
		...
		FileInputStream file = new FileInputStream("C:\\Users\\Admin\\Desktop\\TATA CVBU &  PCBU INPUT DATA\\SpareConsumptionData.xlsx");
		...
		for (int i = 1; i <= rowcount; i++) {
			...
			String region = celldata.getCell(2).getStringCellValue();
			String dealername = celldata.getCell(3).getStringCellValue();
			...
			// click Spares Consumption Invoice Line Items
			
			WebElement clk = driver
					.findElement(By.xpath("//a[text()=\"Spares Consumption Invoice Line Items\"]"));
			...
			WebElement reg = driver
					.findElement(By.xpath("//input[@class=\"promptTextField textFieldHelper\"]"));
			reg.sendKeys(region);
			...
			WebElement div = driver.findElement(
					By.xpath("//input[@class=\"promptTextField textFieldHelper\"]"));
		   ...
		   driver.findElement(By.xpath("//input[@id=\"next\"]")).click();
			...
			wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//a[@name=\"OK\"]")));
