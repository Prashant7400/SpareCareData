...
public class Demo_Non_Moving_Child_Field {
	
	
	// FOR CONSIGNEE TYPE CHILD
...
public static void main (String[] args) throws FileNotFoundException  {
		...
		// CLICK CHILD CONSIGNEE
		
		driver.findElement(By.xpath("//*[@id=\"rediochild\"]")).click();
		
		WebElement MotherLocation = driver.findElement(By.xpath("//*[@id=\"divMother\"]/label"));
		System.out.println(MotherLocation.getText());
