...
public class Script_Workshop_Management_Child_Consignee {
...
//	     	String EndDatewithSpareCare = celldata.getCell(8).getStringCellValue();
			String AuditExecutive = celldata.getCell(9).getStringCellValue();
			String OrderingConsultant = celldata.getCell(10).getStringCellValue();
			String OEMExecutive = celldata.getCell(11).getStringCellValue();
			String Status = celldata.getCell(12).getStringCellValue();
			String SharingStatus = celldata.getCell(13).getStringCellValue();
			String OrderGenerationStatus = celldata.getCell(14).getStringCellValue();
			String BDM = celldata.getCell(15).getStringCellValue();
			String AutoApproval = celldata.getCell(16).getStringCellValue();
			String DeshboardPPNI = celldata.getCell(17).getStringCellValue();
			String LowStockAlert = celldata.getCell(18).getStringCellValue();
			String LiveStocktoSale = celldata.getCell(19).getStringCellValue();
